...
— гидрогеологические наблюдения при бурении скважин;
— отбор проб грунтов для лабораторных испытаний;
— планово-высотная привязка скважин.
...
— статистическая обработка данных лабораторных исследований грунтов;
— обработка данных полевых испытаний грунтов;
— разработка технического отчета по инженерно-геологическим изысканиям.
Сроки выполнения работ: {data['igi_duration_days']} рабочих дней.
...
2.4. Согласование полноты и достоверности нанесения на топографические планы коммуникаций в эксплуатирующих организациях.
2.5. Составление технического отчета по результатам выполненных инженерно-геодезических изысканий.
Сроки выполнения работ: {data['igdi_duration_days']} рабочих дней (в том числе:
— топографическая съёмка и оформление топографического плана – {data['igdi_survey_days']} рабочих дней;
— согласование топографического плана с балансодержателями и составление технического отчета – {data['igdi_coordination_days']} рабочих дней).
Стоимость работ по п. 2: {data['igdi_cost']} руб. с учетом НДС (в том числе:
— топографическая съёмка и оформление топографического плана – {data['igdi_survey_cost']} руб.;
— согласование топографического плана с балансодержателями – {data['igdi_coordination_cost']} руб.;
— составление технического отчета – {data['igdi_report_cost']} руб.).
...
- замеры МЭД гамма-излучения - суммарно {data['iei_gamma_points']} точек в границах участка изысканий;
- исследования влияния физических факторов (шум - {data['iei_noise_points']} точки, ЭМИ - {data['iei_emi_points']} точки);
- отбор {data['iei_soil_samples']} объединенных проб почв с глубины 0,0-0,2 м для проведения санитарно-химического (определение содержания тяжелых металлов, бенз(а)пирена и нефтепродуктов) исследования;
- отбор {data['iei_bio_samples']} объединенных проб почв с глубины 0,0-0,2 м для проведения бактериологического (определение БГКП, энтерококков, патогенных бактерий, в т.ч. сальмонелл) и паразитологического (определение яиц и личинок гельминтов, цист патогенных простейших) и энтомологического (куколки и личинки синантропных мух) исследования;
- послойный отбор {data['iei_layered_samples_deep']} проб грунта из {data['iei_deep_boreholes']} геолог. скважин (послойно с глубин 0,2-1,0 м, 1,0-2,0 м, ..., 14,0-15,0 м) для проведения санитарно-химического (определение содержания тяжелых металлов, бенз(а)пирена и нефтепродуктов) анализа;
- послойный отбор {data['iei_layered_samples_shallow']} пробы грунта из {data['iei_shallow_boreholes']} геолог. скважин (послойно с глубин 0,2-1,0 м) для проведения санитарно-химического (определение содержания тяжелых металлов, бенз(а)пирена и нефтепродуктов) анализа;
- отбор {data['iei_background_soil_samples']} проб почв с глубины 0,0-0,2 м, 0,2-1,0 м, ..., 14,0-15,0 м для проведения санитарно-химического (определение нефтепродуктов фоновая проба) исследования;
- послойный отбор {data['iei_agro_samples']} проб грунта из {data['iei_pits']} шурфа (послойно с глубин 0,0-0,2; 0,2-0,4; 0,4-0,6; 0,6-0,8; 0,8-1,0 м) для проведения агрохимического анализа;
- отбор {data['iei_rad_samples']} объединенных проб почв с глубины 0,0-0,2 м для проведения радиационного исследования;
- отбор {data['iei_water_samples']} пробы подземной воды (при вскрытии) из {data['iei_water_boreholes']} скважины;
- отбор {data['iei_surface_water_samples']} пробы воды из поверхностного водного объекта;
- отбор {data['iei_sediment_samples']} пробы донных отложений из водного объекта;
3.2. Лабораторные исследования проб почв, грунтов;
3.3. Камеральная обработка данных и разработка технического отчета об инженерно-экологических изысканиях;
3.4. Получение справки Росгидромета о фоновых концентрациях загрязняющих веществ в атмосферном воздухе (диоксид азота, оксид углерода, серы диоксид и взвешенные вещества);
3.5. Получение справки Росгидромета о краткой климатической характеристике (для расчета рассеивания ЗВ в атмосферном воздухе);
3.6. Получение справок о наличии/отсутствии:
...
Сроки выполнения работ: {data['iei_duration_days']} рабочих дней.
Стоимость работ по п.3 составит: {data['iei_cost']} руб. с учетом НДС.
...
4.2. Камеральные работы:
- рекогносцировочное обследование. Обработка полевых материалов – {data['igmi_route_km']} км;
- составление таблицы гидрологической изученности бассейна реки при числе пунктов наблюдений до 50 – 1 таблица;
- составление схемы гидрометеорологической изученности бассейна реки при числе пунктов наблюдений до 50 – 1 схема;
- подбор станций или постов с оценкой качества материалов наблюдений и степени их репрезентативности – 1 станция;
- построение розы ветров – {data['igmi_wind_rose_count']} графика;
- оценка возможности затопления/подтопления водными объектами участка изысканий – 1 оценка;
- составление климатической характеристики района – 1 записка;
- составление программы работ – 1 программа;
- составление технического отчета – 1 отчет.

Сроки выполнения работ: {data['igmi_duration_days']} календарных дней.
Стоимость работ по п.4 составит: {data['igmi_cost']} руб. с учетом НДС.
*в стоимость работ не включены:
- полная климатическая справка - по требованию экспертизы."""
